class Restaurant {
    ...
    makeTheOrder(meal){
        ...
        Object.keys(this.stockProducts).forEach(x=>{
            if (mealProducts.some(l=> l.name == x)) {
                let quantityToDecrease = this.menu[meal].products.find(y=>y.name == x);
                this.stockProducts[x] -= quantityToDecrease.quantity;
            }
        })
